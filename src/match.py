...
def find_best_match(query_img_path: str, dictionary_img_paths: List[str]):
...
query_image_path = "../query_img/pikachu.jpg"

# 最も類似する辞書画像を見つける
best_match_path = find_best_match(query_image_path, [img["path"] for img in dictionary_images])
